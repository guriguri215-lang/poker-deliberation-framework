...
- source SHA-256: `f7185646a8e3c4a4f571dc342eafa033d80b5314c8560ac034d99d589df42ee0`
...
|---|---|---|---|---|
| `P2-024A` | `RM-024` | `in_progress` | `RM-006`, `RM-023` | Context envelope policy, schema, ownership, lineage, and allowlists. |
...
| `RM-024` | Context lifecycle contract | `phase-2` | `P1` | `in_progress` | `RM-006`, `RM-023` | `P2-024A` | `approved_scope` |
