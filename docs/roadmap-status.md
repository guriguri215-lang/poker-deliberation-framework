...
- source SHA-256: `ccfbad1771203d8a828b915a024b9b5417e36e6522c632f9221458d298d860cf`
...
| `P2-012A` | `RM-012` | `in_progress` | `RM-023`, `P2-010A`, `P2-011A`, `P2-027A` | Immutable revision storage, manifest, transaction, lock, recovery claim, and revision CAS foundation. |
