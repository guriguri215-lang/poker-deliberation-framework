...
- source SHA-256: `fceed8ccdb7888309e1655e7fc53bea21a9009c9c407bf041c4bb13c41c2ae2d`
...
- Status: `planned`
- Status reason: P2-025B completed a separately named river-only saved-subscription path and retained an optional API mode, but does not start the broad provider milestone. The legacy public subscription record lacks sealed execution attestations, both remote routes remain live-unqualified pending fresh evidence, and RM-019 dependencies and general provider scope remain planned.
